...
1. **Push to GitHub** — make sure your repo is on GitHub. If not:
   ...
   ```bash
   git remote add origin git@github.com:<you>/nazimabad-indoor-sports.git
   git push -u origin main
   ```

2. **Import the project** — go to <https://vercel.com/new> and click
   "Import Git Repository". Pick your `nazimabad-indoor-sports` repo.
...
4. **Click Deploy**. Vercel will:
   ...
   - Give you a `https://nazimabad-indoor-sports-<random>.vercel.app` URL

5. **Add a custom domain** (optional):
   - Go to Project Settings → Domains
   - Add `nazimabadindoorsports.com` (or your domain)
...
| Project name? | `nazimabad-indoor-sports` |
