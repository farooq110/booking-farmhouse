...
<VideoSlot src="https://cdn.nazimabadindoorsports.com/hero.mp4" poster="/poster.jpg" />

// Gallery images — high-res, optimized JPG/WebP
<MediaSlot src="https://cdn.nazimabadindoorsports.com/pool-dusk.jpg" alt="…" />

// Video carousel cells
<VideoCarouselCell src="https://cdn.nazimabadindoorsports.com/pavilion.mp4" label="…" />
```
...
export default function sitemap() {
  return [{ url: "https://nazimabadindoorsports.com", lastModified: new Date() }];
}
```
