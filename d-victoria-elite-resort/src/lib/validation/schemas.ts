 ...
 * D-Victoria Elite. The enquiry goes DIRECTLY to the farmhouse owner —
...
export const guestEnquirySchema = z.object({
  ...
  guests: z
    ...
    .max(16, "Country Farm accommodates up to 16 guests per stay."),
...
export const ADDON_OPTIONS = [
  ...
  { id: "breakfast", label: "Farmhouse breakfast basket daily" },
