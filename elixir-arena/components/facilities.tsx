        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-end">
          ...
          <div className="reveal-header lg:col-span-8 space-y-4">
            ...
            <p className="text-gray-400 font-sans text-base sm:text-lg max-w-2xl">
              Every detail of Elixir Arena has been precision-designed to match real match-day physics. We stripped away the dust, the damp, and the bad bounces of traditional indoor nets to construct a training heaven.
            </p>
          </div>
        </div>
