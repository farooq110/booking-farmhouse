...
export default function Gallery() {
  const photos = [
    ...
    },
    {
      ...
      category: "Live Play",
      desc: "Real match action under high-lux floodlights — the same energy every session at Elixir Arena.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 items-end">
          ...
          <div className="reveal-header lg:col-span-8 space-y-4">
            ...
            <p className="text-gray-400 font-sans text-base sm:text-lg max-w-xl">
              Take a detailed look inside Elixir Arena — the pitch, the lights, the equipment. This is your match day home.
            </p>
          </div>
        </div>
